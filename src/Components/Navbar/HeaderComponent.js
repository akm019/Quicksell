...
const HeaderComponent = () => {
  ...
  const selectedorder = Object.keys(navdata.order).find(
    (key) => navdata.order[key] && key !== 'flag'
  );
 const handlegroup=(e)=>{
 ...
 useEffect(()=>{
  ...
  return (
    <div className="top-header" style={{ paddingLeft: "13px"  ,marginLeft:"30px",marginTop:"8px",marginBottom:"8px"}}>
...
<span style={{ paddingLeft: "6px", position: "relative", top: "-2px" }}>
      Display
    </span>
    <span
  style={{
